...
function App() {
  ...
  } = usePlayRunHistory({ songId: importedSong?.id, beatmap, bpm, beatOffsetMs, enabled: activeTab === 'play', repository: runHistoryRepository })
  ...
  }, [activeTab, armedLanes, gamepadLane, isRecording, parry, quantize, quantizeTime, tapMode])

  useEffect(() => {
    if (activeTab !== 'play' || !isSongPlaying) return
  ...
  }, [activeAttacks, activeTab, isSongPlaying, recordRunJudgements, tuning.parryWindowMs])
  ...
  return (
    <main className={activeTab === 'editor' ? 'editing-layout' : undefined}>
      ...
      <aside className="panel">
        ...
        {activeTab === 'editor' && <>
          {beatmapControls}
          <RunFeedbackSummaryCard summary={feedbackSummary} lastRunSummary={lastRunFeedbackSummary} lastRun={lastPlayRun} showLastRunOnly={showLastRunOnly} onShowLastRunOnlyChange={setShowLastRunOnly} onDiscardRun={deletePlayRun} />
        </>}
